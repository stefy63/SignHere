            ...
            <div class="ibox-title">
                ...
                <div ibox-tools="" class="ng-scope">
                    <div dropdown="" class="ibox-tools dropdown">
                        <a href="{{ url('admin_profiles/create') }}"><span class="badge badge-info"> <i class="fa fa-plus-square-o"   data-toggle="tooltip" title="{{__('admin_profiles.index-tooltip-create')}}"></i></span></a>
                    </div>
                </div>
            </div>
