    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>{{__('admin_mail_template.create-title')}}</h5>
            ...
            <form method="POST" action="{{ route('admin_mail_template.store') }}" id="toast-form">
            {!! csrf_field() !!}
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="js-switch form-control" type="checkbox" data-switchery="true" name="active" @if(old("active") == 1) checked @endif style="display: none;" />
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea id="summernote" name="template" >{{old("template")}}</textarea>
                        </div>
                    </div>
                </div>
                <br>
