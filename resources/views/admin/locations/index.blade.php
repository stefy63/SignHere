            ...
            <div class="ibox-title">
                ...
                <div ibox-tools="" class="ng-scope">
                    <div dropdown="" class="ibox-tools dropdown">
                        <a href="{{ url('admin_locations/create') }}"><span class="badge badge-info"> <i class="fa fa-plus-square-o"   data-toggle="tooltip" title="{{__('admin_locations.index-tooltip-create')}}"></i></span></a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr class="gradeA odd" role="row">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('admin_locations/'.$location->id.'/edit') }}" >
                                                <i class="fa fa-wrench"  data-toggle="tooltip" title="{{__('admin_locations.index-tooltip-update')}}"></i>
                                            </a>
                                            &nbsp;&nbsp;
                                            <a  class="confirm-toast"  data-message="{{__('admin_locations.index-confirm-message')}}"  data-location="{{ url('admin_locations/destroy/'.$location->id) }}">
                                                <i class="fa fa-trash"  data-toggle="tooltip" title="{{__('admin_locations.index-tooltip-delete')}}"></i>
                                            </a>
