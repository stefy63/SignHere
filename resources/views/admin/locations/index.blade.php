            ...
            <div class="ibox-title">
                ...
                <div ibox-tools="" class="ng-scope">
                    <div dropdown="" class="ibox-tools dropdown">
                        <a href="{{ url('admin_locations/create') }}"><span class="btn btn-primary"> <i class="fa fa-plus"   data-toggle="tooltip" title="{{__('admin_locationsindex-tooltip-create')}}"></i> {{__('admin_brands.index-new')}}</span></a>
                    </div>
                </div>
            </div>
