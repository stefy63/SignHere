            ...
            function fPad() {
                ...
                if (wc != true) {
                    ...
                    switch (WizCtl.PadWidth) {
                        case 396:
                            Pad = new TPad("STU-300", 60, 200, 200, 8, 8, 16, 70, 100, 200, 35, 30, 10);
                            zoom = 100;
                            break;
                        case 640:
                            Pad = new TPad("STU-500", 300, 360, 390, 16, 22, 32, 110, 260, 0, 180, 30, 100);
                            zoom = 50;
                            break;
                        case 800:
                            Pad = new TPad("STU-520 or STU-530", 300, 360, 390, 16, 22, 32, 110, 340, 0, 180, 50, 100);
                            zoom = 50;
                            break;
                        case 320:
                            Pad = new TPad("STU-430 or ePad", 100, 130, 150, 10, 12, 16, 110, 120, 0, 45, 30, 15);
                            zoom = 100;
                            break;
                        default:
                            Pad = false;
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
            <div class="ibox float-e-margins col-lg-12 col-md-12 col-xs-12">
                <div class="ibox-title">
                    @if($sign_session)
                        <div class="col-lg-12 col-md-12 col-xs-12 float-e-margins">
                            <div class="col-md-10">
                                <div class="timeline">
                                    <div class="events">
                                        <ol>
                                            <ul>
                                                @foreach($sign_documents as $doc)
                                                    <li>
                                                        <a href="#" @if($doc->signed || $doc->document_id == $document->id) class="selected" @endif>{{$doc->document->name}}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </ol>
...
{{--                                <a href="{{ url('sign') }}" class="confirm-toast" data-message="" data-location="">--}}
                                    <button class="btn btn-primary dim confirm-toast" data-message="{{__('sign.sign_session_terminate')}}" data-location="{{ url('sign') }}">Fine sessione di firma</button>
{{--                                </a>--}}
{{--                                <button class="btn btn-info">Termina sessione di firma</button>--}}
                            </div>
                        </div>
                    @endif
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <h5>{{__('sign.sign-pdf-title')}}: <i class="fa fa-archive"></i> {{$document->dossier->name}}:
                            <i
                                    class="fa fa-minus-square-o" style="color: red;"></i> {{$document->name}} <i
                                    class="fa fa-user"></i>: {{$document->dossier->client->surname.' '.$document->dossier->client->name}}
                        </h5>
                        @if(!$sign_session)
                        <div ibox-tools="" class="ng-scope">
                            <div dropdown="" class="ibox-tools dropdown">
                                <a href="{{ url('sign') }}">
                                    <button class="btn btn-primary dim"><i class="fa fa-arrow-left"></i></button>
                                </a>
                            </div>
                        </div>
                        @endif
                ...
                <div class="ibox-content col-lg-12 col-md-12 col-xs-12">
                    ...
                    <div class="pull-right col-lg-3 col-md-3 col-xs-3">
                        ...
                        <form method="POST" action="{{ route('sign.store_signing',['id' => $document->id]) }}"
                              id="toast-form">
                            ...
                            <table>
                                <tr>
                                    <td rowspan="3" class="col-lg-2 col-md-2 col-xs-2">
                                        <div class="hidden">
                                            <object id="sigCtl1"
                                                    classid="clsid:963B1D81-38B8-492E-ACBE-74801D009E9E"></object>
                                    ...
                                    <td style="padding: 10px 10px;">
                                        <button id="start" type="button" class="btn btn-block btn-outline btn-warning"
                                                title="Starts signature capture">Start
                                        </button>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 10px 10px;">
                                        @if(config('app.debug'))
                                            <button id="about" type="button"
                                                    ...
                                                    title="Starts signature capture">Info
                                            </button>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 10px 10px;">
                                        <button class="btn btn-block btn-outline btn-primary"
                                                title="Starts signature capture" data-form-id="toast-form">Submit
                                        </button>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="row">
                        <div id="tools" class="form-group">
                            ...
                            <div class="col-lg-5 col-md-5 col-xs-5 pull-right">
                                <button class="btn btn-block btn-outline btn-primary col-md-5 pull-right" id="Sig-Save">
                                    Save
                                </button>
                            </div>
                        </div>
