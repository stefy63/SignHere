 ...
 * @version    $Id: Dynamic.php 1419 2020-02-10 17:02:12Z jan.slabon $
 */
    ...
    extends SetaPDF_Signer_Signature_Appearance_AbstractAppearance
{
     ...
     *
     * @param string $key The key of the config. See and use SetaPDF_Signer_Signature_Appearance_Dynamic::CONFIG_XXX for a valid key.
     * @param mixed $value
    ...
    public function getCertificateInfo()
    {
        if ($this->_certificateInfo === null) {
            $this->_certificateInfo = openssl_x509_parse($this->_module->getCertificate());
            if ($this->_certificateInfo === false && is_file($this->_module->getCertificate())) {
                $this->_certificateInfo = openssl_x509_parse('file://' . $this->_module->getCertificate());
            }
